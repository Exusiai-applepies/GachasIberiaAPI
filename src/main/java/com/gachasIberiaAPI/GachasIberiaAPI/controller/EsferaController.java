...
import com.gachasIberiaAPI.GachasIberiaAPI.service.EsferaService;
...
@RestController
@RequestMapping("/api/gachasIberia/esfera")
public class EsferaController {
    private final EsferaService service;

    public EsferaController(EsferaService service) {
    ...
    @GetMapping
    public ResponseEntity<List<Esfera>> findAll() {
        List<Esfera> manufacturers = this.service.findAll();
    ...
    public ResponseEntity<List<Esfera>> findByTitulo(@PathVariable String nombre) {
        List<Esfera> encontrado = this.service.findByNombre(nombre);
    ...
    @PostMapping
    public ResponseEntity<Esfera> create(@RequestBody Esfera starrailPersonaje) {
    ...
    @PutMapping
    public ResponseEntity<Esfera> update(@RequestBody Esfera manufacturer) {
