...
import com.gachasIberiaAPI.GachasIberiaAPI.service.JuegoService;
...
@RestController
@RequestMapping("/api/gachasIberia/Juego")
public class JuegoController {
    ...
    public ResponseEntity<List<Juego>> findAll() {
        List<Juego> manufacturers = this.service.findAll();
    ...
    public ResponseEntity<List<Juego>> findByTitulo(@PathVariable String nombre) {
        List<Juego> encontrado = this.service.findByNombre(nombre);
    ...
    @PostMapping
    public ResponseEntity<Juego> create(@RequestBody Juego starrailPersonaje) {
    ...
    @PutMapping
    public ResponseEntity<Juego> update(@RequestBody Juego manufacturer) {
