...
import com.gachasIberiaAPI.GachasIberiaAPI.service.ArtefactoService;
...
@RestController
@RequestMapping("/api/gachasIberia/artefacto")
public class ArtefactoController {
    private final ArtefactoService service;

    public ArtefactoController(ArtefactoService service) {
    ...
    @GetMapping
    public ResponseEntity<List<Artefacto>> findAll() {
        List<Artefacto> manufacturers = this.service.findAll();
    ...
    public ResponseEntity<List<Artefacto>> findByTitulo(@PathVariable String nombre) {
        List<Artefacto> encontrado = this.service.findByNombre(nombre);
    ...
    @PostMapping
    public ResponseEntity<Artefacto> create(@RequestBody Artefacto starrailPersonaje) {
    ...
    @PutMapping
    public ResponseEntity<Artefacto> update(@RequestBody Artefacto manufacturer) {
